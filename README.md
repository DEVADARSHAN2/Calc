        ...
        <tr>
          ...
          <td>
            <button
              data-operator="-"
              onclick="appendToDisplay('-')"
              style="background-color: rgb(0, 255, 81); color: white"
            >
              -
            </button>
          </td>
          <td>
            <button
              data-operator="%"
              onclick="appendToDisplay('%')"
              style="background-color: rgb(251, 0, 255); color: white"
            >
              %
            </button>
          </td>
...
```
## OUTPUT:
![Screenshot 2023-11-16 122945](https://github.com/DEVADARSHAN2/Calc/assets/119432150/4606d76e-9611-451d-b697-a88fa5db03ff)
